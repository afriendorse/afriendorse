...
import 'package:afriendorse/common/widgets/ldashed_line_printer.dart';
import 'package:get/get.dart';
import 'package:afriendorse/feature/review/controller/submit_review_controller.dart';
import 'package:afriendorse/feature/review/widgets/select_rating.dart';
                            ...
                            children: [
                              ...
                              ListView.builder(
                                itemBuilder: (context, index) {
                                  ...
                                  final service = submitReviewController
                                      .serviceReviewList?[index];
                                  final serviceId = service?.id;
                                  final editable = serviceId != null
                                  ...
                                  return Padding(
                                    ...
                                    child: service == null || serviceId == null
          ...
          children: [
            ...
            Container(
              ...
              child: Center(
                child: TextFormField(
                  maxLines: 4,
                  controller: widget.serviceReview?.id != null
                      ? submitReviewController.textControllers[widget
                            .serviceReview!
                            .id]
                      : null,
