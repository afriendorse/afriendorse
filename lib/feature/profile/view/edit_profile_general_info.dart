                          ...
                          children: [
                            ...
                            Tooltip(
                              ...
                              message: config?.emailVerification == 1
                                  ...
                                  : "",
                              child: AbsorbPointer(
                                // Prevents any interaction with the field
                                absorbing: true,
                                child: CustomTextField(
                                  title: 'email'.tr,
                                  hintText: 'email'.tr,
                                  focusNode: _emailFocus,
                                  controller: emailController,
                                  // Disable the field so it cannot be edited
                                  isEnabled: false,
                                  ...
                                  child: CustomTextField(
                                    onCountryChanged:
                                        (CountryCode countryCode) {
                                          // Country code change is blocked
                                          // since the field is uneditable
                                        },
                                    countryDialCode:
                                        userController.countryDialCode,
                                    title: 'phone'.tr,
                                    hintText: 'enter_phone_number'.tr,
                                    // Always disabled regardless of verification
                                    isEnabled: false,
                                    inputType: TextInputType.phone,
                                    focusNode: _phoneWithCountry,
                                    controller: phoneController,
                                    suffixIconUrl:
                                        ...
                                        ? Images.error
                                        : null,
                                    // Suffix tap blocked since field is uneditable
                                    onSuffixTap: null,
                                    onValidate: (String? value) {
                                      if (value == null || value.isEmpty) {
                                        return 'enter_phone_number'.tr;
                    ...
                    onPressed: () {
                      if (updateProfileKey.currentState!.validate()) {
                        UserInfoModel userInfoModel = UserInfoModel(
                          fName: firstNameController.text.trim(),
                          lName: lastNameController.text.trim(),
                          // Still send original values to the API
                          email: emailController.text.trim(),
                          phone:
                              userController.countryDialCode +
                              phoneController.value.text.trim(),
