import 'package:afriendorse/feature/provider/view/nearby_provider/widget/nearby_provider_list_item_view.dart';
      ...
      builder: (nearbyProviderController) {
        return nearbyProviderController.providerList != null &&
            ...
            ? PaginatedListView(
                ...
                totalSize:
                    nearbyProviderController.providerModel?.content?.total,
                limit: nearbyProviderController.providerModel?.content?.perPage,
                onPaginate: (int offset) async => await nearbyProviderController
                    .getProviderList(offset, false),
                offset: nearbyProviderController
                    .providerModel
                    ?.content
                    ?.currentPage,
                itemView: Expanded(
