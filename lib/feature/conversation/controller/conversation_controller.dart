...
class ConversationController extends GetxController
  ...
  // ✅ ADD THIS METHOD HERE (after onInit)
  @override
  void onClose() {
    tabController?.dispose();
    channelScrollController1.dispose();
    channelScrollController2.dispose();
  ...
  Future<void> createChannel(
    ...
    if (response.statusCode == 200) {
      final String channelId = response.body['content']['id'];

      // ✅ Fix: Defer navigation until after current frame
