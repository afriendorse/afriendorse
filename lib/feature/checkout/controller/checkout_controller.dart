import 'dart:convert';
import 'package:afriendorse/common/widgets/confirmation_widget.dart';
import 'package:afriendorse/feature/checkout/model/payment_response_model.dart';
...
class CheckOutController extends GetxController implements GetxService {
  ...
  Future<void> placeBookingRequest({
    ...
    String zoneId = Get.find<LocationController>()
        .getUserAddress()!
        .zoneId
        .toString();
