                            ...
                            children: offlinePaymentMethodList
                                .map(
                                  (offline) => AutoScrollTag(
                                    ...
                                    index: offlinePaymentMethodList.indexOf(
                                      offline,
                                    ),
                                    child: InkWell(
                                      onTap: () async {
                                        ...
                                        await scrollController!.scrollToIndex(
                                          offlinePaymentMethodList.indexOf(
                                            offline,
                                          ),
                                          preferPosition:
                          ...
                          for (
                            ...
                            value.addAll({
                              "${checkoutController.selectedOfflineMethod!.customerInformation?[i].fieldName}":
                                  checkoutController
                                      .offlinePaymentInputField[i]
                                      .text,
                            });
                          }
                          checkoutController.offlinePaymentInputFieldValues.add(
                            value,
                          );
