...
import 'package:afriendorse/feature/search/widget/filtter_remove_item.dart';
...
class AlreadyFilteredWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GetBuilder<AllSearchController>(
                  ...
                  child: ListView.builder(
                    itemBuilder: (context, index) {
                      return FilterRemoveItem(
                        title:
                            "${searchController.sortedByList[index].title}".tr,
                        onTap: () async {
                          Get.dialog(
                            const CustomLoader(),
