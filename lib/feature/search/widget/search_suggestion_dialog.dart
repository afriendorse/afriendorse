...
import 'package:afriendorse/feature/search/widget/realtime_search_suggestion.dart';
import 'package:afriendorse/feature/search/widget/recommended_search.dart';
      ...
      builder: (searchController) {
        return Container(
          margin: EdgeInsets.only(
            top: ResponsiveHelper.isDesktop(context) ? 0 : 72,
          ),
          ...
          child: Column(
            ...
            children: [
              ResponsiveHelper.isDesktop(context)
                  ? const WebMenuBar(openSearchDialog: false)
                  ...
                  child: Padding(
                    ...
                    child:
                        ...
                        ? RealTimeSearchSuggestion(
                            suggestionList:
                                searchController.searchSuggestionList,
                          )
                        : const Column(
                            children: [
                              RecentSearch(),
