              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return InkWell(
                      onTap: () => searchController.updateSortBy(
                        searchController.sortBy[index],
                      ),
                      child: Container(
              ...
              ListView.builder(
                itemBuilder: (context, index) {
                  return RadioGroup<String>(
                    ...
                    onChanged: (val) {
                      searchController.updateSortByType(
                        searchController.sortByType[index],
                      );
                    },
                    child: RadioListTile(
                      ...
                      title: Text(
                        searchController.sortByType[index].tr,
                        style: robotoRegular.copyWith(
                          fontSize: Dimensions.fontSizeDefault,
                          color: Theme.of(context).textTheme.bodyMedium?.color,
                        ),
