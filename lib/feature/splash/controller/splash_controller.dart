...
class SplashController extends GetxController implements GetxService {
  ...
  Future<void> updateLanguage(bool isInitial) async {
    try {
      ...
      if (!isInitial) {
        // 🔴 FIX: Make sure response.body is not null and is a map before reading keys
        if (response.statusCode == 200 &&
          ...
          String errorMessage = response.body != null && response.body is Map
      ...
      printLog("====> Failed to update language: $e");
    }
  }
