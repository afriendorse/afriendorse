...
class MyPostData {
  ...
  // ── NEW: Targeted athlete fields ───────────────────────────────────────────
  String? targetProviderId;
  ProviderData? targetProvider;
  // ── END NEW ───────────────────────────────────────────────────────────────
  ...
  MyPostData.fromJson(Map<String, dynamic> json) {
    ...
    // ── NEW: Parse targeted athlete fields ───────────────────────────────────
    targetProviderId = json['target_provider_id'];
    targetProvider = json['target_provider'] != null
        ? ProviderData.fromJson(json['target_provider'])
        : null;
    // ── END NEW ───────────────────────────────────────────────────────────────
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    // ── NEW: Serialize targeted athlete fields ───────────────────────────────
    data['target_provider_id'] = targetProviderId;
    if (targetProvider != null) {
      data['target_provider'] = targetProvider!.toJson();
    }
    // ── END NEW ─────────────────────────────────────────────────────────────
