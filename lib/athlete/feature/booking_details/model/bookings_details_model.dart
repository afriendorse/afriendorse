import 'package:afriendorse/athlete/feature/dashboard/model/dashboard_serviceman_model.dart';
import 'package:afriendorse/athlete/feature/review/model/review_model.dart';
import 'package:afriendorse/athlete/feature/serviceman/model/service_man_model.dart';
...
class BookingDetailsContent {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (bookingOfflinePayment != null) {
      data['booking_offline_payment'] = bookingOfflinePayment!
          .map((v) => v.toJson())
          .toList();
    }
