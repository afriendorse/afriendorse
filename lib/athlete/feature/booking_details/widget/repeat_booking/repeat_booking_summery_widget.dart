import 'package:afriendorse/athlete/feature/booking_details/widget/repeat_booking/repeat_booking_edit_history_widget.dart';
...
class RepeatBookingSummeryWidget extends StatelessWidget {
  ...
  const RepeatBookingSummeryWidget({
    super.key,
    ...
    return Column(
      ...
      children: [
        ...
        if (bookingService?.variantKey != null)
          Padding(
            padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeTini),
            child: Row(
