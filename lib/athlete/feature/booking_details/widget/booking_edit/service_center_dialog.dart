...
class _ProductBottomSheetState extends State<ServiceCenterDialog> {
  ...
  void initState() {
    super.initState();
    Get.find<BookingEditController>().resetSelectedServiceVariationQuantity(
          ...
          child: Column(
            ...
            children: [
                            ...
                            children: [
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "${widget.service?.variations?[index].variantKey.toString().capitalizeFirst}"
                                          .replaceAll('-', ' '),
                                      style: robotoMedium.copyWith(
              ...
              CustomButton(
                ...
                onPressed: bookingEditController.isCartButtonActive
                    ? () async {
                        await bookingEditController.addMultipleCartItem(
                          widget.selectedServiceIndex,
                        );
                        Get.back();
                      }
