...
class TimelineTheme extends StatelessWidget {
  ...
  const TimelineTheme({super.key, required this.data, required this.child});
  ...
  Widget build(BuildContext context) {
    return _InheritedTheme(
      theme: this,
      child: IndicatorTheme(data: data.indicatorTheme, child: child),
    );
  }
...
class TimelineThemeData with Diagnosticable {
  ...
  factory TimelineThemeData.vertical() =>
      TimelineThemeData(direction: Axis.vertical);

  factory TimelineThemeData.horizontal() =>
  ...
  static TimelineThemeData lerp(
    ...
    return TimelineThemeData.raw(
      ...
      indicatorPosition: lerpDouble(
        a.indicatorPosition,
        b.indicatorPosition,
        t,
      )!,
      indicatorTheme: IndicatorThemeData.lerp(
        a.indicatorTheme,
        b.indicatorTheme,
        t,
      ),
      connectorTheme: ConnectorThemeData.lerp(
        a.connectorTheme,
        b.connectorTheme,
        t,
      ),
    ...
    properties
      ..add(
        DiagnosticsProperty<Axis>(
          'direction',
          direction,
          defaultValue: defaultData.direction,
      ...
      ..add(
        DoubleProperty(
          'nodePosition',
          nodePosition,
          defaultValue: defaultData.nodePosition,
          level: DiagnosticLevel.debug,
        ),
      )
      ..add(
        FlagProperty(
          'nodeItemOverlap',
          value: nodeItemOverlap,
          ifTrue: 'overlap connector and indicator',
        ),
      )
      ..add(
        DoubleProperty(
      ...
      ..add(
        DiagnosticsProperty<IndicatorThemeData>(
          'indicatorTheme',
          indicatorTheme,
      ...
      ..add(
        DiagnosticsProperty<ConnectorThemeData>(
          'connectorTheme',
          connectorTheme,
