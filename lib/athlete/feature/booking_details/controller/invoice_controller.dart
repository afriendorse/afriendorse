...
import 'package:afriendorse/athlete/feature/booking_details/controller/booking_details_controller.dart';
import 'package:afriendorse/athlete/feature/booking_details/model/bookings_details_model.dart';
import 'package:afriendorse/athlete/feature/booking_details/model/invoice.dart';
import 'package:afriendorse/athlete/feature/booking_details/model/supplier.dart';
import 'package:afriendorse/athlete/feature/splash/controller/splash_controller.dart';
import 'package:pdf/pdf.dart';
import 'package:pdf/widgets.dart' as pw;
import 'package:pdf/widgets.dart';
import 'package:afriendorse/athlete/feature/booking_details/model/provider.dart'
    as provider;
...
class PdfInvoiceApi {
  static Future<File> generate(
    ...
    return PdfApi.saveDocument(
      name: 'invoice_${bookingDetailsContent.readableId}.pdf',
      pdf: pdf,
    );
  }
  ...
  static Widget companyImage(
    ...
    return Column(
      children: [
        ...
        Row(
          children: [
            Container(width: 140, height: 140, child: pw.Image(netImage)),
          ],
        ),
      ],
    );
  ...
  static Widget buildCustomerAddress(
    ...
    children: [
      Text(
        'Invoice Number # ${bookingDetailsContent.readableId!}',
      ...
      Text(
        "Payment Status: ${bookingDetailsContent.partialPayments != null && bookingDetailsContent.partialPayments!.isNotEmpty && bookingDetailsContent.isPaid == 0
            ? "Partially paid"
            : bookingDetailsContent.isPaid.toString() == '0'
            ? 'Unpaid'
            : 'Paid'}",
        style: pw.TextStyle(fontSize: 14, fontWeight: pw.FontWeight.bold),
      ),
  ...
  static Widget buildInvoice(Invoice invoice) {
    ...
    return TableHelper.fromTextArray(
      ...
      cellHeight: 30,
      columnWidths: {0: FixedColumnWidth(Get.width / 4)},
      cellAlignments: {
