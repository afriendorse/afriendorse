// lib/athlete/feature/donations/individual_donation_payment_method_sheet.dart
...
class IndividualDonationPaymentMethodSheet extends StatefulWidget {
  final double amount;
  final VoidCallback onWalletPayment;
  final VoidCallback onOnlinePayment;

  const IndividualDonationPaymentMethodSheet({
    super.key,
  ...
  @override
  State<IndividualDonationPaymentMethodSheet> createState() =>
      _IndividualDonationPaymentMethodSheetState();
}

class _IndividualDonationPaymentMethodSheetState
    extends State<IndividualDonationPaymentMethodSheet> {
