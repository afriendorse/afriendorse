// lib/athlete/feature/campaigns/screens/campaign_payment_method_sheet.dart
...
class CampaignPaymentMethodSheet extends StatefulWidget {
  ...
  @override
  State<CampaignPaymentMethodSheet> createState() =>
      _CampaignPaymentMethodSheetState();
}

class _CampaignPaymentMethodSheetState extends State<CampaignPaymentMethodSheet>
  ...
  Future<void> _loadWalletBalance() async {
    try {
      ...
      if (kDebugMode) {
        print('[CampaignPaymentSheet] WalletController not found: $e');
      }
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    final isMonthly = widget.frequency == DonationFrequency.monthly;
    final showWalletOption = _walletAvailable && !isMonthly;
      ...
      child: Column(
        ...
        children: [
          ...
          _PaymentOptionTile(
            ...
            title: 'Pay Online',
            subtitle: isMonthly
                ? 'Card will be saved for monthly charges'
                : 'Debit card, bank transfer & more',
            trailing: Container(
              ...
              child: Row(
                ...
                children: [
                  Icon(
                    isMonthly ? Icons.autorenew : Icons.shield_outlined,
                    size: 11,
                    color: Colors.blue[700],
                  ),
                  const SizedBox(width: 3),
                  Text(
                    isMonthly ? 'Required' : 'Secure',
                    style: TextStyle(
                      fontSize: 11,
                      color: Colors.blue[700],
                      fontWeight: FontWeight.w600,
          ...
          if (showWalletOption && !_isLoadingBalance && !_hasEnoughBalance) ...[
            const SizedBox(height: 16),
            Builder(
              builder: (context) {
                final shortfall = widget.amount - _walletBalance;
