...
import 'package:afriendorse/athlete/feature/notifications/model/notofication_model.dart';
...
class NotificationController extends GetxController implements GetxService {
  ...
  void onInit() {
    ...
    scrollController.addListener(() {
      if (scrollController.position.maxScrollExtent / 2 <
  ...
  Future<void> getNotifications(
    int offset, {
    bool reload = true,
    bool saveNotificationCount = true,
  }) async {
    _offset = offset;
