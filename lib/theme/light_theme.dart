import 'package:afriendorse/theme/custom_theme_colors.dart';
import 'package:flutter/material.dart';

ThemeData light = ThemeData(
  useMaterial3: false,
  fontFamily: 'Roboto',
  primaryColor: const Color(0xFF045F25),
  primaryColorLight: const Color(0xFFECEDF7),
  primaryColorDark: const Color(0xFF045F25),
  ...
  //appbarr: const Color(0xFF045F25),
  textButtonTheme: TextButtonThemeData(
    style: TextButton.styleFrom(foregroundColor: const Color(0xFF045F25)),
  ),
