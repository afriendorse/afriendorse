import 'dart:convert';
import 'package:afriendorse/athlete/feature/campaigns/screens/manage_subscriptions_screen.dart';
...
import 'package:afriendorse/feature/auth/view/update_profile_screen.dart';
import 'package:afriendorse/feature/booking/view/repeat_booking_details_screen.dart';
import 'package:afriendorse/feature/checkout/view/offline_payment_screen.dart';
import 'package:afriendorse/feature/home/all_category_screen.dart';
import 'package:afriendorse/feature/home/brand_dash.dart';
import 'package:afriendorse/feature/home/fan_dash.dart';
import 'package:afriendorse/feature/provider/view/nearby_provider/near_by_provider_screen.dart';
import 'package:afriendorse/feature/referral/view/referral_screen.dart';
...
class RouteHelper {
  ...
  // NEW: Split dashboard routes for NIL platform
  static const String brandDashboard = '/brand-dashboard';
  static const String fanDashboard = '/fan-dashboard';
  ...
  static String getReferralRoute() => referral;
  ...
  static String getManageSubscriptionsRoute() => manageSubscriptions;
  ...
  static String getCreatePostScreen({
    String? schedule,
    String? targetProviderId, // NEW: null = open post, set = targeted athlete
  }) {
    List<int> encoded = utf8.encode(jsonEncode(schedule));
    String data = base64Encode(encoded);
    if (targetProviderId != null && targetProviderId.isNotEmpty) {
      return "$createPost?schedule=$data&targetProviderId=$targetProviderId";
    }
  ...
  // NEW: Dashboard route getters
  static String getBrandDashboardRoute() => brandDashboard;
  static String getFanDashboardRoute() => fanDashboard;
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
      ...
      page: () => CreatePostScreen(
        // NEW: reads targetProviderId from URL params
        // null when coming from homepage banner (open post)
        // set  when coming from athlete details page (targeted post)
        targetProviderId: Get.parameters['targetProviderId'],
      ),
    ...
    // NEW: Brand Dashboard Route
    GetPage(
      name: brandDashboard,
      page: () =>
          const BrandDashboardScreen(showServiceNotAvailableDialog: false),
      middlewares: [AuthMiddleware(pageTitle: 'brand_dashboard')],
    ),

    GetPage(
      name: manageSubscriptions,
      page: () => const ManageSubscriptionsScreen(),
      middlewares: [AuthMiddleware(pageTitle: 'subscriptions')],
    ),

    // NEW: Fan Dashboard Route
    GetPage(
      name: fanDashboard,
      page: () =>
          const FanDashboardScreen(showServiceNotAvailableDialog: false),
      middlewares: [AuthMiddleware(pageTitle: 'fan_dashboard')],
    ),
    //
  ];
