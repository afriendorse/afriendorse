...
import 'package:afriendorse/common/widgets/staggered_list_animation.dart';
import 'package:afriendorse/common/widgets/custom_highlight_animation_widget.dart';
import 'package:afriendorse/feature/location/widget/pickmap_dialog_widget.dart';
        ...
        InkWell(
          onTap: () {
            ...
            if (fromDrawer) {
              ...
              Get.dialog(
                PickMapDialogWidget(
                  previousAddress: Get.find<LocationController>()
                      .getUserAddress(),
                ),
              );
            } else {
