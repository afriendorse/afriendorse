...
import 'package:afriendorse/common/widgets/demo_reset_dialog_widget.dart';
import 'package:afriendorse/feature/booking/widget/booking_ignored_bottom_sheet.dart';
  ...
  static Future<void> showBigTextNotification(
    ...
    if (!Get.find<AuthController>().isNotificationActive()) {
      AndroidNotificationDetails androidPlatformChannelSpecifics =
          AndroidNotificationDetails(
            "afriendorseWithoutsound",
            "afriendorse without sound",
